...
const rateRegionDefinitions = [
  ...
  },
  {
    ...
    icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Airport.png',
  },
];
...
const baseRuleProviders = {
  ...
  private: {
    ...
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/private.mrs',
    path: './ruleset/private.mrs',
    'path-in-bundle': 'geo/geosite/private.mrs',
  },
  private_ip: {
    ...ruleProviderCommonIpcidr,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/private.mrs',
    path: './ruleset/private_ip.mrs',
    'path-in-bundle': 'geo/geoip/private.mrs',
  },
  games_cn: {
    ...ruleProviderCommonDomain,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/category-games@cn.mrs',
    path: './ruleset/category-games@cn.mrs',
    'path-in-bundle': 'geo/geosite/category-games@cn.mrs',
  },
  epicgames: {
    ...ruleProviderCommonDomain,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/epicgames.mrs',
    path: './ruleset/epicgames.mrs',
    'path-in-bundle': 'geo/geosite/epicgames.mrs',
  },
  nvidia_cn: {
    ...ruleProviderCommonDomain,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/nvidia@cn.mrs',
    path: './ruleset/nvidia@cn.mrs',
    'path-in-bundle': 'geo/geosite/nvidia@cn.mrs',
  },
  apple_cn: {
    ...ruleProviderCommonDomain,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/apple@cn.mrs',
    path: './ruleset/apple@cn.mrs',
    'path-in-bundle': 'geo/geosite/apple@cn.mrs',
  },
  microsoft_cn: {
    ...ruleProviderCommonDomain,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/microsoft@cn.mrs',
    path: './ruleset/microsoft@cn.mrs',
    'path-in-bundle': 'geo/geosite/microsoft@cn.mrs',
  },
  'geolocation-cn': {
    ...ruleProviderCommonDomain,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/geolocation-cn.mrs',
    path: './ruleset/geolocation-cn.mrs',
    'path-in-bundle': 'geo/geosite/geolocation-cn.mrs',
  },
  cn_ip: {
    ...ruleProviderCommonIpcidr,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/cn.mrs',
  ...
  fakeip_filter: {
    ...ruleProviderCommonDomain,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/fakeip-filter.mrs',
  ...
  cn: {
    ...ruleProviderCommonDomain,
    url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/cn.mrs',
    path: './ruleset/cn.mrs',
    'path-in-bundle': 'geo/geosite/cn.mrs',
  },
};
...
const serviceConfigs = [
  ...baseGroups,
  {
    ...
    providers: {
      googlefcm: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/googlefcm.mrs',
        path: './ruleset/googlefcm.mrs',
        'path-in-bundle': 'geo/geosite/googlefcm.mrs',
      },
    },
    icon: 'https://testingcf.jsdelivr.net/gh/MiToverG422/Qure@master/IconSet/Color/fcm.png',
  ...
  },
  {
    ...
    providers: {
      youtube: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/youtube.mrs',
  ...
  },
  {
    ...
    providers: {
      google: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/google.mrs',
        path: './ruleset/google.mrs',
        'path-in-bundle': 'geo/geosite/google.mrs',
      },
      google_ip: {
        ...ruleProviderCommonIpcidr,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/google.mrs',
  ...
  },
  {
    ...
    providers: {
      ai: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/category-ai-!cn.mrs',
        path: './ruleset/ai.mrs',
  ...
  },
  {
    ...
    providers: {
      github: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/github.mrs',
        path: './ruleset/github.mrs',
        'path-in-bundle': 'geo/geosite/github.mrs',
      },
      microsoft: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/microsoft.mrs',
  ...
  },
  {
    ...
    providers: {
      apple: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/apple.mrs',
  ...
  },
  {
    ...
    providers: {
      telegram: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/telegram.mrs',
        path: './ruleset/telegram.mrs',
        'path-in-bundle': 'geo/geosite/telegram.mrs',
      },
      telegram_ip: {
        ...ruleProviderCommonIpcidr,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/telegram.mrs',
  ...
  },
  {
    ...
    providers: {
      steam: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/steam.mrs',
        path: './ruleset/steam.mrs',
        'path-in-bundle': 'geo/geosite/steam.mrs',
      },
      steam_ip: {
        ...ruleProviderCommonIpcidr,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/steam.mrs',
  ...
  },
  {
    ...
    providers: {
      tiktok: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/tiktok.mrs',
        path: './ruleset/tiktok.mrs',
        'path-in-bundle': 'geo/geosite/tiktok.mrs',
      },
      tiktok_ip: {
        ...ruleProviderCommonIpcidr,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/tiktok.mrs',
  ...
  },
  {
    ...
    providers: {
      twitter: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/twitter.mrs',
        path: './ruleset/twitter.mrs',
        'path-in-bundle': 'geo/geosite/twitter.mrs',
      },
      twitter_ip: {
        ...ruleProviderCommonIpcidr,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/twitter.mrs',
  ...
  },
  {
    ...
    providers: {
      instagram: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/instagram.mrs',
  ...
  },
  {
    ...
    providers: {
      netflix: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/netflix.mrs',
        path: './ruleset/netflix.mrs',
        'path-in-bundle': 'geo/geosite/netflix.mrs',
      },
      netflix_ip: {
        ...ruleProviderCommonIpcidr,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/netflix.mrs',
  ...
  },
  {
    ...
    providers: {
      emby: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/666OS/rules@release/mihomo/domain/Emby.mrs',
        path: './ruleset/emby.mrs',
        'path-in-bundle': 'geo/geosite/category-emby.mrs',
      },
      emos: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/binaryu/emos-proxy-rule@main/rules/emos-mihomo.mrs',
  ...
  },
  {
    ...
    providers: {
      pikpak: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/pikpak.mrs',
        path: './ruleset/pikpak.mrs',
        'path-in-bundle': 'geo/geosite/pikpak.mrs',
      },
    },
    icon: 'https://testingcf.jsdelivr.net/gh/lige47/QuanX-icon-rule@main/icon/03CNSoft/pikpak.png',
  ...
  },
  {
    ...
    providers: {
      spotify: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/spotify.mrs',
        path: './ruleset/spotify.mrs',
        'path-in-bundle': 'geo/geosite/spotify.mrs',
      },
      spotify_ip: {
        ...ruleProviderCommonIpcidr,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/spotify.mrs',
  ...
  },
  {
    ...
    providers: {
      cryptocurrency: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/category-cryptocurrency.mrs',
        path: './ruleset/cryptocurrency.mrs',
        'path-in-bundle': 'geo/geosite/category-cryptocurrency.mrs',
      },
    },
    icon: 'https://testingcf.jsdelivr.net/gh/lige47/QuanX-icon-rule@main/icon/04ProxySoft/Bitcoin.png',
  ...
  },
  {
    ...
    providers: {
      ehentai: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geosite/ehentai.mrs',
        path: './ruleset/ehentai.mrs',
        'path-in-bundle': 'geo/geosite/ehentai.mrs',
      },
    },
    icon: 'https://testingcf.jsdelivr.net/gh/lige47/QuanX-icon-rule@main/icon/04ProxySoft/exhentai.png',
  ...
  },
  {
    ...
    providers: {
      adblockmihomolite: {
        ...ruleProviderCommonDomain,
        url: 'https://testingcf.jsdelivr.net/gh/217heidai/adblockfilters@main/rules/adblockmihomolite.mrs',
...
function buildRegionGroups(filteredProxies, customProxies) {
  ...
  if (otherProxies.length > 0) {
    generatedRegionGroups.push(
      ...createRegionGroup(
        '其他节点',
        'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/World_Map.png',
        otherProxies,
      ),
    );
  }
